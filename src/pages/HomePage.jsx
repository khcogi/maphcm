      ...
      <section className="mx-auto max-w-5xl px-4 pb-16">
        <div className="rounded-2xl border border-slate-700 bg-slate-900/60 p-4">
          <div className="flex flex-wrap gap-3">
            <Link to="/map" className="rounded-xl bg-cyan-400 px-4 py-2 text-sm font-semibold text-slate-950">
              {t.mapBtn}
            </Link>
            <Link to="/quiz" className="rounded-xl border border-slate-600 px-4 py-2 text-sm text-slate-200">
              {t.quizBtn}
            </Link>
          </div>
        </div>
